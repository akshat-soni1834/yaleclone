...
function MainApplication() {
    return (
        <div style={{ backgroundColor: `#f5f5f5`, opacity: "0.9", backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}>
            <Navbar />
            <div className='container d-flex flex-column align-items-center justify-content-center' >
                <h1 className='p-2 m-4 rounded-3' style={{ fontStyle: "oblique", color: "#660000" }}>APPLY TO THE SCHOOL</h1>
                ...
                <div className='d-flex flex-wrap align-items-center justify-content-center'>
                    <div className="p-3 mb-4 rounded-3 d-flex align-items-center justify-content-center shadow-lg  m-2" style={{ backgroundColor: "#ffffcc", height: "300px", width: "300px" }}>
