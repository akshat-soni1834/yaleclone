...
function MainAbout() {
    return (
        <div style={{ backgroundColor: `#f5f5f5`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', opacity: "0.9", height: "100%" }}>
            <Navbar />
            <div className='container d-flex flex-column align-items-center justify-content-center' >
                <h1 className='p-2 m-4 rounded-3' style={{ fontStyle: "oblique", color: "#660000" }}>ABOUT THE SCHOOL</h1>
                ...
                <div className="p-3 mb-4 rounded-3 flex-wrap shadow-lg" style={{ backgroundColor: "#ccffff" }}>
                    <div className="container-fluid py-3">
                        <h4 className="" style={{ color: "#00004d" }}>MASTER OF FINE ARTS DEGREE (MFAS)</h4>
                ...
                <div className="p-3 mb-4 rounded-3 flex-wrap shadow-lg" style={{ backgroundColor: "#ffe6ff" }}>
                    <div className="container-fluid py-3">
                        <h4 className="" style={{ color: "#660066" }}>PUBLIC LECTURES AND EXHIBITIONS</h4>
