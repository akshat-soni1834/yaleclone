...
function Events() {
    return (
        <div>
            <div style={{backgroundColor: `#f5f5f5`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', opacity: '5.0' }}>

                <Navbar />

                <h1 className='text-center p-2 m-4 rounded-3' style={{ fontStyle: "oblique", color: "#660000" }}>PUBLIC EVENTS</h1>
